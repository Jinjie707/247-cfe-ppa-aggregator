...
class NoPenNewBatNewAsset(OptimizationCase):
    """
    Optimization Case 3: OPtimizing for New Battery and New Asset.

    Attributes:
        Attributed initialized from parent class.
        New Gen and New Bat attributes to be initialized seperately to remind this case.
    """
